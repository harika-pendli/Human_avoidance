You can find recipes for using Google \mbox{\hyperlink{class_mock}{Mock}} here. If you haven\textquotesingle{}t yet, please read the For\+Dummies document first to make sure you understand the basics.

{\bfseries{Note\+:}} Google \mbox{\hyperlink{class_mock}{Mock}} lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by Google \mbox{\hyperlink{class_mock}{Mock}}. We omit such {\ttfamily using} statements in this page for brevity, but you should do it in your own code.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md231}{}\doxysection{Creating Mock Classes}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md231}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md232}{}\doxysubsection{Mocking Private or Protected Methods}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md232}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md233}{}\doxysubsection{Mocking Overloaded Methods}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md233}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md234}{}\doxysubsection{Mocking Class Templates}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md234}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md235}{}\doxysubsection{Mocking Nonvirtual Methods}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md235}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md236}{}\doxysubsection{Mocking Free Functions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md236}
...
If you are concerned about the performance overhead incurred by virtual functions, and profiling confirms your concern, you can combine this with the recipe for mocking non-\/virtual methods.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md237}{}\doxysubsection{Nice Mocks and Strict Mocks}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md237}
...
Finally, you should be {\bfseries{very cautious}} when using this feature, as the decision you make applies to {\bfseries{all}} future changes to the mock class. If an important change is made in the interface you are mocking (and thus in the mock class), it could break your tests (if you use {\ttfamily Strict\+Mock}) or let bugs pass through without a warning (if you use {\ttfamily Nice\+Mock}). Therefore, try to specify the mock\textquotesingle{}s behavior using explicit {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL} first, and only turn to {\ttfamily Nice\+Mock} or {\ttfamily Strict\+Mock} as the last resort.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md238}{}\doxysubsection{Simplifying the Interface without Breaking Existing Code}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md238}
...
By defining a new mock method with a trimmed argument list, we make the mock class much more user-\/friendly.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md239}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md239}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md240}{}\doxysubsection{Delegating Calls to a Fake}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md240}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily I\+O\+Ops} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily I\+O\+Ops} without mocking {\ttfamily File\+Ops}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md241}{}\doxysubsection{Delegating Calls to a Real Object}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md241}
...
(Why don\textquotesingle{}t we just write {\ttfamily Invoke(\&foo, \&\+Foo\+::\+Concrete)}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md243}{}\doxysection{Using Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md243}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md244}{}\doxysubsection{Matching Argument Values Exactly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md244}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md245}{}\doxysubsection{Using Simple Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md245}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md246}{}\doxysubsection{Combining Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md246}
...
\DoxyCodeLine{                          NULL));}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md247}{}\doxysubsection{Casting Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md247}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md248}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md248}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md249}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md249}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md250}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md250}
...
As a convenience and example, Google \mbox{\hyperlink{class_mock}{Mock}} provides some matchers for 2-\/tuples, including the {\ttfamily \mbox{\hyperlink{namespacetesting_ad621459957a8bcdd3c256b7940ecbf99}{Lt()}}} matcher above. See the Cheat\+Sheet for the complete list.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md251}{}\doxysubsection{Using Matchers as Predicates}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md251}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md252}{}\doxysubsection{Using Matchers in Google Test Assertions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md252}
...
{\bfseries{Credit\+:}} The idea of {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+T\+H\+AT} was stolen from the \href{http://code.google.com/p/hamcrest/}{\texttt{ Hamcrest}} project, which adds {\ttfamily assert\+That()} to J\+Unit.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md253}{}\doxysubsection{Using Predicates as Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md253}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in statement {\ttfamily if (condition) ...}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md254}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md254}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}}, or the result is undefined.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md255}{}\doxysubsection{Validating a Member of an Object}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md255}
...
What if you want to validate more than one members at the same time? Remember that there is {\ttfamily \mbox{\hyperlink{namespacetesting_af7618e8606c1cb45738163688944e2b7}{All\+Of()}}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md256}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md256}
C++ functions often take pointers as arguments. You can use matchers like {\ttfamily N\+U\+LL}, {\ttfamily \mbox{\hyperlink{namespacetesting_a39d1f92b53b8b2a0b6db6a22ac146416}{Not\+Null()}}}, and other comparison matchers to match a pointer, but what if you want to make sure the value {\itshape pointed to} by the pointer, instead of the pointer itself, has a certain property? Well, you can use the {\ttfamily Pointee(m)} matcher.
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily \mbox{\hyperlink{namespacetesting_a5122ca3533f3a00f67e146dd81f3b68c}{Pointee()}}} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md257}{}\doxysubsection{Testing a Certain Property of an Object}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md257}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md258}{}\doxysubsection{Matching Containers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md258}
...
You can use the {\ttfamily \mbox{\hyperlink{namespacetesting_a79cf4ae694bf8231dcf283b325405f27}{Elements\+Are()}}} matcher in such cases\+:
...
{\ttfamily \mbox{\hyperlink{namespacetesting_a79cf4ae694bf8231dcf283b325405f27}{Elements\+Are()}}} is overloaded to take 0 to 10 arguments. If more are needed, you can place them in a C-\/style array and use {\ttfamily \mbox{\hyperlink{namespacetesting_ae2eee06e7ddbf5f5372fd24372e9703f}{Elements\+Are\+Array()}}} instead\+:
...
\end{DoxyItemize}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md259}{}\doxysubsection{Sharing Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md259}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md260}{}\doxysection{Setting Expectations}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md260}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md261}{}\doxysubsection{Ignoring Uninteresting Calls}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md261}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} statement, it will be an error.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md262}{}\doxysubsection{Disallowing Unexpected Calls}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md262}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} statements will be an error.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md263}{}\doxysubsection{Expecting Ordered Calls}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md263}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, Google \mbox{\hyperlink{class_mock}{Mock}} will report an error.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md264}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md264}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md265}{}\doxysubsection{Controlling When an Expectation Retires}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md265}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md266}{}\doxysection{Using Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md266}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md267}{}\doxysubsection{Returning References from Mock Methods}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md267}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md268}{}\doxysubsection{Combining Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md268}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md269}{}\doxysubsection{Mocking Side Effects}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md269}
...
If all you need to do is to change an output argument, the built-\/in {\ttfamily \mbox{\hyperlink{namespacetesting_a03b315d27c91a8e719f2b6c09964130b}{Set\+Argument\+Pointee()}}} action is convenient\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{using ::testing::SetArgumentPointee;}
\DoxyCodeLine{}
...
\DoxyCodeLine{      .WillOnce(SetArgumentPointee<1>(5));}
\end{DoxyCode}
...
\DoxyCodeLine{      .WillOnce(DoAll(SetArgumentPointee<0>(5),}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md270}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md270}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md271}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md271}
...
Please note that changing the default value for a type can make you tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md272}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md272}
...
As you may have guessed, when there are more than one {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a5b12ae6cf84f0a544ca811b380c37334}{O\+N\+\_\+\+C\+A\+L\+L()}}} statements, the news order take precedence over the older ones. In other words, the {\bfseries{last}} one that matches the function arguments will be used. This matching order allows you to set up the common behavior in a mock object\textquotesingle{}s constructor or the test fixture\textquotesingle{}s set-\/up phase and specialize the mock\textquotesingle{}s behavior later.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md273}{}\doxysubsection{Using Functions/\+Methods/\+Functors as Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md273}
...
The only requirement is that the type of the function, etc must be {\itshape compatible} with the signature of the mock function, meaning that the latter\textquotesingle{}s arguments can be implicitly converted to the corresponding arguments of the former, and the former\textquotesingle{}s return type can be implicitly converted to that of the latter. So, you can invoke something whose type is {\itshape not} exactly the same as the mock function, as long as it\textquotesingle{}s safe to do so -\/ nice, huh?\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md274}{}\doxysubsection{Invoking a Function/\+Method/\+Functor Without Arguments}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md274}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md275}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md275}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md276}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md276}
...
Note that you {\bfseries{cannot}} use {\ttfamily \mbox{\hyperlink{namespacetesting_a50ae42540a31047c7fddd32df8d835f5}{Ignore\+Result()}}} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md277}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md277}
...
\end{DoxyItemize}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md278}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md278}
...
\DoxyCodeLine{      .WillOnce(Invoke(DistanceToOrigin));}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md279}{}\doxysubsection{Sharing Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md279}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{Action<bool(int*)> set\_flag = DoAll(SetArgumentPointee<0>(5),}
\DoxyCodeLine{                                    Return(true));}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md280}{}\doxysection{Misc Recipes on Using Google Mock}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md280}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md281}{}\doxysubsection{Forcing a Verification}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md281}
...
{\bfseries{Tip\+:}} The {\ttfamily Mock\+::\+Verify\+And\+Clear\+Expectations()} function returns a {\ttfamily bool} to indicate whether the verification was successful ({\ttfamily true} for yes), so you can wrap that function call inside a {\ttfamily \mbox{\hyperlink{gtest_8h_ae9244bfbda562e8b798789b001993fa5}{A\+S\+S\+E\+R\+T\+\_\+\+T\+R\+U\+E()}}} if there is no point going further when the verification has failed.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md282}{}\doxysubsection{Using Check Points}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md282}
...
And that\textquotesingle{}s that.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md284}{}\doxysubsection{Using Google Mock and Threads}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md284}
{\bfseries{I\+M\+P\+O\+R\+T\+A\+NT N\+O\+TE\+:}} What we describe in this recipe is {\bfseries{N\+OT}} true yet, as Google \mbox{\hyperlink{class_mock}{Mock}} is not currently thread-\/safe. However, all we need to make it thread-\/safe is to implement some synchronization operations in {\ttfamily $<$\mbox{\hyperlink{gtest-port_8h}{gtest/internal/gtest-\/port.\+h}}$>$} -\/ and then the information below will become true.
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md285}{}\doxysubsection{Controlling How Much Information Google Mock Prints}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md285}
...
Now, judiciously use the right flag to enable Google \mbox{\hyperlink{class_mock}{Mock}} serve you better!\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md286}{}\doxysubsection{Running Tests in Emacs}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md286}
...
Then you can type {\ttfamily M-\/m} to start a build, or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md287}{}\doxysubsection{Fusing Google Mock Source Files}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md287}
...
and you should see an {\ttfamily O\+U\+T\+P\+U\+T\+\_\+\+D\+IR} directory being created with files {\ttfamily \mbox{\hyperlink{gtest_8h}{gtest/gtest.\+h}}}, {\ttfamily \mbox{\hyperlink{gmock_8h}{gmock/gmock.\+h}}}, and {\ttfamily gmock-\/gtest-\/all.\+cc} in it. These three files contain everything you need to use Google \mbox{\hyperlink{class_mock}{Mock}} (and Google Test). Just copy them to anywhere you want and you are ready to write tests and use mocks. You can use the \href{http://code.google.com/p/googlemock/source/browse/trunk/scripts/test/Makefile}{\texttt{ scrpts/test/\+Makefile}} file as an example on how to compile your tests against them.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md288}{}\doxysection{Extending Google Mock}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md288}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md289}{}\doxysubsection{Writing New Matchers Quickly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md289}
The {\ttfamily M\+A\+T\+C\+H\+E\+R$\ast$} family of macros can be used to define custom matchers easily. The syntax\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{MATCHER(name, "description string") \{ statements; \}}
\end{DoxyCode}
...
The description string documents what the matcher does, and is used to generate the failure message when the match fails. Since a {\ttfamily \mbox{\hyperlink{gmock-generated-matchers_8h_af4fe73ff8e2b0494f4970b575b65ddff}{M\+A\+T\+C\+H\+E\+R()}}} is usually defined in a header file shared by multiple C++ source files, we require the description to be a C-\/string {\itshape literal} to avoid possible side effects. It can be empty ({\ttfamily \char`\"{}\char`\"{}}), in which case Google \mbox{\hyperlink{class_mock}{Mock}} will use the sequence of words in the matcher name as the description.
...
or, 
\begin{DoxyCode}{0}
\DoxyCodeLine{// Verifies that the value of some\_expression is divisible by 7.}
...
\end{DoxyEnumerate}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md290}{}\doxysubsection{Writing New Parameterized Matchers Quickly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md290}
Sometimes you\textquotesingle{}ll want to define a matcher that has parameters. For that you can use the macro\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{MATCHER\_P(name, param\_name, "description string") \{ statements; \}}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{MATCHER\_Pk(name, param\_1, ..., param\_k, "description string") \{ statements; \}}
\end{DoxyCode}
...
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\ttfamily \%\%} }&\cellcolor{\tableheadbgcolor}\textbf{ a single {\ttfamily \%} character  }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
...
For example, 
\begin{DoxyCode}{0}
\DoxyCodeLine{MATCHER\_P2(InClosedRange, low, hi, "is in range [\%(low)s, \%(hi)s]") \{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{MATCHER\_Pk(Foo, p1, ..., pk, "description string") \{ ... \}}
\end{DoxyCode}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md293}{}\doxysubsection{Writing New Cardinalities}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md293}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md294}{}\doxysubsection{Writing New Actions Quickly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md294}
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md295}{}\doxysubsection{Writing New Parameterized Actions Quickly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md295}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md296}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an A\+C\+T\+I\+ON}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md296}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in Google Test that verifies two types are the same.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md297}{}\doxysubsection{Writing New Action Templates Quickly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md297}
...
\DoxyCodeLine{  *output = T(std::tr1::get<k>(args));}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md298}{}\doxysubsection{Using the A\+C\+T\+I\+O\+N Object\textquotesingle{}s Type}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md298}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md299}{}\doxysubsection{Writing New Monomorphic Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md299}
...
\DoxyCodeLine{  // be int, and ArgumentTuple would be tr1::tuple<bool, const string\&>.}
...
\DoxyCodeLine{ public:}
\DoxyCodeLine{  virtual int Perform(const tr1::tuple<int*>\& args) \{}
\DoxyCodeLine{    int* p = tr1::get<0>(args);  // Grabs the first argument.}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md300}{}\doxysubsection{Writing New Polymorphic Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md300}
The previous recipe showed you how to define your own action. This is all good, except that you need to know the type of the function in which the action will be used. Sometimes that can be a problem. For example, if you want to use the action in functions with {\itshape different} types (e.\+g. like {\ttfamily \mbox{\hyperlink{namespacetesting_af6d1c13e9376c77671e37545cd84359c}{Return()}}} and {\ttfamily \mbox{\hyperlink{namespacetesting_a03b315d27c91a8e719f2b6c09964130b}{Set\+Argument\+Pointee()}}}).
...
\DoxyCodeLine{    // To get the i-\/th (0-\/based) argument, use tr1::get<i>(args).}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md301}{}\doxysubsection{Teaching Google Mock How to Print Your Values}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md301}
...
\DoxyCodeLine{// namespace that defines Foo.  C++'s look-\/up rules rely on that.}
\DoxyCodeLine{::std::ostream\& operator<<(::std::ostream\& os, const Foo\& foo) \{}
\DoxyCodeLine{  return os << foo.DebugString();  // Whatever needed to print foo to os.}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\}  // namespace foo}
\end{DoxyCode}
...
Sometimes, this might not be an option. For example, your team may consider it dangerous or bad style to have a {\ttfamily $<$$<$} operator for {\ttfamily Foo}, or {\ttfamily Foo} may already have a {\ttfamily $<$$<$} operator that doesn\textquotesingle{}t do what you want (and you cannot change it). Don\textquotesingle{}t despair though -\/ Google \mbox{\hyperlink{class_mock}{Mock}} gives you a second chance to get it right. Namely, you can define a {\ttfamily \mbox{\hyperlink{namespacetesting_1_1internal_a8fd10cc30084c36a89c74868c8bd53f8}{Print\+To()}}} function like this\+:
...
\DoxyCodeLine{// namespace that defines Foo.  C++'s look-\/up rules rely on that.}
\DoxyCodeLine{void PrintTo(const Foo\& foo, ::std::ostream* os) \{}
\DoxyCodeLine{  *os << foo.DebugString();  // Whatever needed to print foo to os.}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\}  // namespace foo}
\end{DoxyCode}
...
What if you have both {\ttfamily $<$$<$} and {\ttfamily \mbox{\hyperlink{namespacetesting_1_1internal_a8fd10cc30084c36a89c74868c8bd53f8}{Print\+To()}}}? In this case, the latter will override the former when Google \mbox{\hyperlink{class_mock}{Mock}} is concerned. This allows you to customize how the value should appear in Google \mbox{\hyperlink{class_mock}{Mock}}\textquotesingle{}s output without affecting code that relies on the behavior of its {\ttfamily $<$$<$} operator.

{\bfseries{Note\+:}} When printing a pointer of type {\ttfamily T$\ast$}, Google \mbox{\hyperlink{class_mock}{Mock}} calls {\ttfamily Print\+To(\+T$\ast$, std\+::ostream$\ast$ os)} instead of {\ttfamily operator$<$$<$(std\+::ostream\&, T$\ast$)}. Therefore the only way to affect how a pointer is printed by Google \mbox{\hyperlink{class_mock}{Mock}} is to define {\ttfamily \mbox{\hyperlink{namespacetesting_1_1internal_a8fd10cc30084c36a89c74868c8bd53f8}{Print\+To()}}} for it. Also note that {\ttfamily T$\ast$} and {\ttfamily const T$\ast$} are different types, so you may need to define {\ttfamily \mbox{\hyperlink{namespacetesting_1_1internal_a8fd10cc30084c36a89c74868c8bd53f8}{Print\+To()}}} for both.

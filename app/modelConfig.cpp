...
std::vector<std::string> ModelConfig::getClasses() { return class_names; }

std::string ModelConfig::getConfig() { return modelConfigLoc; }

std::string ModelConfig::getWeights() { return modelWeightsLoc; }

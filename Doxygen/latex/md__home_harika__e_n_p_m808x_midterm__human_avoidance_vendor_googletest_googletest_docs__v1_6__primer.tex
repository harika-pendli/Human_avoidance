...
{\itshape Note\+:} We sometimes refer to Google C++ Testing Framework informally as {\itshape Google Test}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1056}{}\doxysection{Setting up a New Test Project}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1056}
...
If you still have questions, take a look at how Google Test\textquotesingle{}s own tests are built and use them as examples.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1057}{}\doxysection{Basic Concepts}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1057}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test cases.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1058}{}\doxysection{Assertions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1058}
...
Anything that can be streamed to an {\ttfamily ostream} can be streamed to an assertion macro--in particular, C strings and {\ttfamily string} objects. If a wide string ({\ttfamily wchar\+\_\+t$\ast$}, {\ttfamily T\+C\+H\+A\+R$\ast$} in {\ttfamily U\+N\+I\+C\+O\+DE} mode on Windows, or {\ttfamily std\+::wstring}) is streamed to an assertion, it will be translated to U\+T\+F-\/8 when printed.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1059}{}\doxysubsection{Basic Assertions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1059}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1060}{}\doxysubsection{Binary Comparison}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1060}
...
See also\+: For more string comparison tricks (substring, prefix, suffix, and regular expression matching, for example), see the \mbox{\hyperlink{_v1__6___advanced_guide_8md}{Advanced Google Test Guide}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1062}{}\doxysection{Simple Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1062}
To create a test\+:
\begin{DoxyEnumerate}
...
Google Test groups the test results by test cases, so logically-\/related tests should be in the same test case; in other words, the first argument to their {\ttfamily \mbox{\hyperlink{gtest_8h_ad8b332753515c0ab8baada563c2547eb}{T\+E\+S\+T()}}} should be the same. In the above example, we have two tests, {\ttfamily Handles\+Zero\+Input} and {\ttfamily Handles\+Positive\+Input}, that belong to the same test case {\ttfamily Factorial\+Test}.

{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1063}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1063}
...
For each test defined with {\ttfamily \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{T\+E\+S\+T\+\_\+\+F()}}}, Google Test will\+:
\begin{DoxyEnumerate}
...
{\itshape Note}\+: Google Test automatically saves all {\itshape Google Test} flags when a test object is constructed, and restores them when it is destructed.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1064}{}\doxysection{Invoking the Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1064}
{\ttfamily \mbox{\hyperlink{gtest_8h_ad8b332753515c0ab8baada563c2547eb}{T\+E\+S\+T()}}} and {\ttfamily \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{T\+E\+S\+T\+\_\+\+F()}}} implicitly register their tests with Google Test. So, unlike with many other C++ testing frameworks, you don\textquotesingle{}t have to re-\/list all your defined tests in order to run them.
...
{\itshape Important}\+: You must not ignore the return value of {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}}, or {\ttfamily gcc} will give you a compiler error. The rationale for this design is that the automated testing service determines whether a test has passed based on its exit code, not on its stdout/stderr output; thus your {\ttfamily \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}} function must return the value of {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}}.

Also, you should call {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}} only {\bfseries{once}}. Calling it more than once conflicts with some advanced Google Test features (e.\+g. thread-\/safe death tests) and thus is not supported.

{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1065}{}\doxysection{Writing the main() Function}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1065}
...
The {\ttfamily \mbox{\hyperlink{namespacetesting_afd726ae08c9bd16dc52f78c822d9946b}{testing\+::\+Init\+Google\+Test()}}} function parses the command line for Google Test flags, and removes all recognized flags. This allows the user to control a test program\textquotesingle{}s behavior via various flags, which we\textquotesingle{}ll cover in \mbox{\hyperlink{_v1__6___advanced_guide_8md}{Advanced\+Guide}}. You must call this function before calling {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}}, or the flags won\textquotesingle{}t be properly initialized.
...
But maybe you think that writing all those \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}} functions is too much work? We agree with you completely and that\textquotesingle{}s why Google Test provides a basic implementation of \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}. If it fits your needs, then just link your test with gtest\+\_\+main library and you are good to go.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1066}{}\doxysubsection{Important note for Visual C++ users}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1066}
...
There is one more pitfall, though. If you use Google Test as a static library (that\textquotesingle{}s how it is defined in gtest.\+vcproj) your tests must also reside in a static library. If you have to have them in a D\+LL, you {\itshape must} change Google Test to build into a D\+LL as well. Otherwise your tests will not run correctly or will not run at all. The general conclusion here is\+: make your life easier -\/ do not write your tests in libraries!\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1067}{}\doxysection{Where to Go from Here}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1067}
Congratulations! You\textquotesingle{}ve learned the Google Test basics. You can start writing and running Google Test tests, read some \mbox{\hyperlink{_v1__6___samples_8md}{samples}}, or continue with \mbox{\hyperlink{_v1__6___advanced_guide_8md}{Advanced\+Guide}}, which describes many more useful Google Test features.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1068}{}\doxysection{Known Limitations}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__primer_autotoc_md1068}

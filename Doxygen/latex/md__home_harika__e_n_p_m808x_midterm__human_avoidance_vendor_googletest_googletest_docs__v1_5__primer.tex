...
{\itshape Note\+:} We sometimes refer to Google C++ Testing Framework informally as {\itshape Google Test}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md917}{}\doxysection{Setting up a New Test Project}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md917}
...
Once you are able to compile the Google Test library, you should create a project or build target for your test program. Make sure you have {\ttfamily G\+T\+E\+S\+T\+\_\+\+R\+O\+O\+T/include} in the header search path so that the compiler can find {\ttfamily $<$\mbox{\hyperlink{gtest_8h}{gtest/gtest.\+h}}$>$} when compiling your test. Set up your test project to link with the Google Test library (for example, in Visual Studio, this is done by adding a dependency on {\ttfamily gtest.\+vcproj}).

If you still have questions, take a look at how Google Test\textquotesingle{}s own tests are built and use them as examples.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md918}{}\doxysection{Basic Concepts}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md918}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test cases.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md919}{}\doxysection{Assertions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md919}
...
Anything that can be streamed to an {\ttfamily ostream} can be streamed to an assertion macro--in particular, C strings and {\ttfamily string} objects. If a wide string ({\ttfamily wchar\+\_\+t$\ast$}, {\ttfamily T\+C\+H\+A\+R$\ast$} in {\ttfamily U\+N\+I\+C\+O\+DE} mode on Windows, or {\ttfamily std\+::wstring}) is streamed to an assertion, it will be translated to U\+T\+F-\/8 when printed.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md920}{}\doxysubsection{Basic Assertions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md920}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md921}{}\doxysubsection{Binary Comparison}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md921}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md922}{}\doxysubsection{String Comparison}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md922}
...
See also\+: For more string comparison tricks (substring, prefix, suffix, and regular expression matching, for example), see the \mbox{[}Advanced\+Guide Advanced Google Test Guide\mbox{]}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md923}{}\doxysection{Simple Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md923}
To create a test\+:
\begin{DoxyEnumerate}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md924}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md924}
...
{\itshape Note}\+: Google Test automatically saves all {\itshape Google Test} flags when a test object is constructed, and restores them when it is destructed.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md925}{}\doxysection{Invoking the Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md925}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md926}{}\doxysection{Writing the main() Function}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md926}
...
But maybe you think that writing all those \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}} functions is too much work? We agree with you completely and that\textquotesingle{}s why Google Test provides a basic implementation of \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}. If it fits your needs, then just link your test with gtest\+\_\+main library and you are good to go.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md927}{}\doxysubsection{Important note for Visual C++ users}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md927}
...
There is one more pitfall, though. If you use Google Test as a static library (that\textquotesingle{}s how it is defined in gtest.\+vcproj) your tests must also reside in a static library. If you have to have them in a D\+LL, you {\itshape must} change Google Test to build into a D\+LL as well. Otherwise your tests will not run correctly or will not run at all. The general conclusion here is\+: make your life easier -\/ do not write your tests in libraries!\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md928}{}\doxysection{Where to Go from Here}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md928}
Congratulations! You\textquotesingle{}ve learned the Google Test basics. You can start writing and running Google Test tests, read some \mbox{\hyperlink{_samples_8md}{samples}}, or continue with \mbox{\hyperlink{_v1__5___advanced_guide_8md}{Advanced\+Guide}}, which describes many more useful Google Test features.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md929}{}\doxysection{Known Limitations}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_5__primer_autotoc_md929}

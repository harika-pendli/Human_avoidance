...
{\itshape Note\+:} We sometimes refer to Google C++ Testing Framework informally as {\itshape Google Test}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1197}{}\doxysection{Setting up a New Test Project}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1197}
...
If you still have questions, take a look at how Google Test\textquotesingle{}s own tests are built and use them as examples.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1198}{}\doxysection{Basic Concepts}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1198}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test cases.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1199}{}\doxysection{Assertions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1199}
...
Anything that can be streamed to an {\ttfamily ostream} can be streamed to an assertion macro--in particular, C strings and {\ttfamily string} objects. If a wide string ({\ttfamily wchar\+\_\+t$\ast$}, {\ttfamily T\+C\+H\+A\+R$\ast$} in {\ttfamily U\+N\+I\+C\+O\+DE} mode on Windows, or {\ttfamily std\+::wstring}) is streamed to an assertion, it will be translated to U\+T\+F-\/8 when printed.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1200}{}\doxysubsection{Basic Assertions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1200}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1201}{}\doxysubsection{Binary Comparison}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1201}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1202}{}\doxysubsection{String Comparison}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1202}
...
See also\+: For more string comparison tricks (substring, prefix, suffix, and regular expression matching, for example), see the \mbox{\hyperlink{_v1__7___advanced_guide_8md}{Advanced Google Test Guide}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1203}{}\doxysection{Simple Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1203}
To create a test\+:
\begin{DoxyEnumerate}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1204}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1204}
...
{\itshape Note}\+: Google Test automatically saves all {\itshape Google Test} flags when a test object is constructed, and restores them when it is destructed.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1205}{}\doxysection{Invoking the Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1205}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1206}{}\doxysection{Writing the main() Function}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1206}
...
But maybe you think that writing all those \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}} functions is too much work? We agree with you completely and that\textquotesingle{}s why Google Test provides a basic implementation of \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}. If it fits your needs, then just link your test with gtest\+\_\+main library and you are good to go.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1207}{}\doxysubsection{Important note for Visual C++ users}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1207}
...
There is one more pitfall, though. If you use Google Test as a static library (that\textquotesingle{}s how it is defined in gtest.\+vcproj) your tests must also reside in a static library. If you have to have them in a D\+LL, you {\itshape must} change Google Test to build into a D\+LL as well. Otherwise your tests will not run correctly or will not run at all. The general conclusion here is\+: make your life easier -\/ do not write your tests in libraries!\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1208}{}\doxysection{Where to Go from Here}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1208}
Congratulations! You\textquotesingle{}ve learned the Google Test basics. You can start writing and running Google Test tests, read some \mbox{\hyperlink{_v1__7___samples_8md}{samples}}, or continue with \mbox{\hyperlink{_v1__7___advanced_guide_8md}{Advanced\+Guide}}, which describes many more useful Google Test features.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1209}{}\doxysection{Known Limitations}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1209}

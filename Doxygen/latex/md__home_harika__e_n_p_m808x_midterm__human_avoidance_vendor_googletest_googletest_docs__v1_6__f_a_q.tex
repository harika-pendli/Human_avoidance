If you cannot find the answer to your question here, and you have read \mbox{\hyperlink{_v1__6___primer_8md}{Primer}} and \mbox{\hyperlink{_v1__6___advanced_guide_8md}{Advanced\+Guide}}, send it to \href{mailto:googletestframework@googlegroups.com}{\texttt{ googletestframework@googlegroups.\+com}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1008}{}\doxysubsection{Why should I use Google Test instead of my favorite C++ testing framework?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1008}
...
\item Simple things are easy in Google Test, while hard things are possible\+: in addition to advanced features like \href{V1_6_AdvancedGuide.md\#Global_Set-Up_and_Tear-Down}{\texttt{ global test environments}} and tests parameterized by \href{V1_6_AdvancedGuide.md\#value-parameterized-tests}{\texttt{ values}} or \href{V1_6_AdvancedGuide.md\#typed-tests}{\texttt{ types}}, Google Test supports various ways for the user to extend the framework -- if Google Test doesn\textquotesingle{}t do something out of the box, chances are that a user can implement the feature using Google Test\textquotesingle{}s public A\+PI, without changing Google Test itself. In particular, you can\+:
\begin{DoxyItemize}
\item expand your testing vocabulary by defining \href{V1_6_AdvancedGuide.md\#predicate-assertions-for-better-error-messages}{\texttt{ custom predicates}},
\item teach Google Test how to \href{V1_6_AdvancedGuide.md\#teaching-google-test-how-to-print-your-values}{\texttt{ print your types}},
\item define your own testing macros or utilities and verify them using Google Test\textquotesingle{}s \href{V1_6_AdvancedGuide.md\#catching-failures}{\texttt{ Service Provider Interface}}, and
\item reflect on the test cases or change the test output format by intercepting the \href{V1_6_AdvancedGuide.md\#extending-google-test-by-handling-test-events}{\texttt{ test events}}.
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1009}{}\doxysubsection{I\textquotesingle{}m getting warnings when compiling Google Test.  Would you fix them?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1009}
...
If you see warnings when compiling Google Test, we suggest that you use the {\ttfamily -\/isystem} flag (assuming your are using G\+CC) to mark Google Test headers as system headers. That\textquotesingle{}ll suppress warnings from Google Test headers.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1010}{}\doxysubsection{Why should not test case names and test names contain underscore?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1010}
...
If you violate the rule, there may not be immediately consequences, but your test may (just may) break with a new compiler (or a new version of the compiler you are using) or with a new version of Google Test. Therefore it\textquotesingle{}s best to follow the rule.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1011}{}\doxysubsection{Why is it not recommended to install a pre-\/compiled copy of Google Test (for example, into /usr/local)?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1011}
...
In order to prevent build output files from overwriting one another, you\textquotesingle{}ll need to change the {\ttfamily Intermediate Directory} settings for the newly created platform configuration across all the projects. To do this, multi-\/select (e.\+g. using shift-\/click) all projects (but not the solution) in the {\ttfamily Solution Explorer}. Right-\/click one of them and select {\ttfamily Properties}. In the left pane, select {\ttfamily Configuration Properties}, and from the {\ttfamily Configuration} dropdown, select {\ttfamily All Configurations}. Make sure the selected platform is {\ttfamily x64}. For the {\ttfamily Intermediate Directory} setting, change the value from {\ttfamily \textbackslash{}} to {\ttfamily \textbackslash{}}. Click {\ttfamily OK} and then build the solution. When the build is complete, the 64-\/bit binaries will be in the {\ttfamily msvc\textbackslash{}x64\textbackslash{}Debug} directory.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1013}{}\doxysubsection{Can I use Google Test on Min\+G\+W?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1013}
...
Please contact {\ttfamily googletestframework@googlegroups.\+com} if you are interested in improving the support for Min\+GW.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1014}{}\doxysubsection{Why does Google Test support E\+X\+P\+E\+C\+T\+\_\+\+E\+Q(\+N\+U\+L\+L, ptr) and A\+S\+S\+E\+R\+T\+\_\+\+E\+Q(\+N\+U\+L\+L, ptr) but not E\+X\+P\+E\+C\+T\+\_\+\+N\+E(\+N\+U\+L\+L, ptr) and A\+S\+S\+E\+R\+T\+\_\+\+N\+E(\+N\+U\+L\+L, ptr)?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1014}
...
Finally, with the growth of Google \mbox{\hyperlink{class_mock}{Mock}}\textquotesingle{}s \href{../../CookBook.md\#using-matchers-in-google-test-assertions}{\texttt{ matcher}} library, we are encouraging people to use the unified {\ttfamily \mbox{\hyperlink{gmock-matchers_8h_ac31e206123aa702e1152bb2735b31409}{E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+A\+T(value, matcher)}}} syntax more often in tests. One significant advantage of the matcher approach is that matchers can be easily combined to form new matchers, while the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+NE}, etc, macros cannot be easily combined. Therefore we want to invest more in the matchers than in the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+X\+X()} macros.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1015}{}\doxysubsection{Does Google Test support running tests in parallel?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1015}
Test runners tend to be tightly coupled with the build/test environment, and Google Test doesn\textquotesingle{}t try to solve the problem of running tests in parallel. Instead, we tried to make Google Test work nicely with test runners. For example, Google Test\textquotesingle{}s X\+ML report contains the time spent on each test, and its {\ttfamily gtest\+\_\+list\+\_\+tests} and {\ttfamily gtest\+\_\+filter} flags can be used for splitting the execution of test methods into multiple processes. These functionalities can help the test runner run the tests in parallel.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1016}{}\doxysubsection{Why don\textquotesingle{}t Google Test run the tests in different threads to speed things up?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1016}
...
If you think about it, it\textquotesingle{}s already hard to make your code work when you know what other threads are doing. It\textquotesingle{}s much harder, and sometimes even impossible, to make your code work when you don\textquotesingle{}t know what other threads are doing (remember that test methods can be added, deleted, or modified after your test was written). If you want to run the tests in parallel, you\textquotesingle{}d better run them in different processes.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1017}{}\doxysubsection{Why aren\textquotesingle{}t Google Test assertions implemented using exceptions?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1017}
...
The downside of not using exceptions is that {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$} (implemented using {\ttfamily return}) will only abort the current function, not the current {\ttfamily T\+E\+ST}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1018}{}\doxysubsection{Why do we use two different macros for tests with and without fixtures?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1018}
...
We think neither approach is ideal, yet either of them is reasonable. In the end, it probably doesn\textquotesingle{}t matter much either way.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1019}{}\doxysubsection{Why don\textquotesingle{}t we use structs as test fixtures?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1019}
We like to use structs only when representing passive data. This distinction between structs and classes is good for documenting the intent of the code\textquotesingle{}s author. Since test fixtures have logic like {\ttfamily Set\+Up()} and {\ttfamily Tear\+Down()}, they are better defined as classes.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1020}{}\doxysubsection{Why are death tests implemented as assertions instead of using a test runner?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1020}
...
Another interesting thing about {\ttfamily A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+TH} is that it calls {\ttfamily fork()} to create a child process to run the death test. This is lightening fast, as {\ttfamily fork()} uses copy-\/on-\/write pages and incurs almost zero overhead, and the child process starts from the user-\/supplied statement directly, skipping all global and local initialization and any code leading to the given statement. If you launch the child process from scratch, it can take seconds just to load everything and start running if the test links to many libraries dynamically.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1021}{}\doxysubsection{My death test modifies some state, but the change seems lost after the death test finishes. Why?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1021}
Death tests ({\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+D\+E\+A\+TH}, etc) are executed in a sub-\/process s.\+t. the expected crash won\textquotesingle{}t kill the test program (i.\+e. the parent process). As a result, any in-\/memory side effects they incur are observable in their respective sub-\/processes, but not in the parent process. You can think of them as running in a parallel universe, more or less.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1022}{}\doxysubsection{The compiler complains about \char`\"{}undefined references\char`\"{} to some static const member variables, but I did define them in the class body. What\textquotesingle{}s wrong?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1022}
...
Otherwise your code is {\bfseries{invalid C++}}, and may break in unexpected ways. In particular, using it in Google Test comparison assertions ({\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+EQ}, etc) will generate an \char`\"{}undefined reference\char`\"{} linker error.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1023}{}\doxysubsection{I have an interface that has several implementations. Can I write a set of tests once and repeat them over all the implementations?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1023}
Google Test doesn\textquotesingle{}t yet have good support for this kind of tests, or data-\/driven tests in general. We hope to be able to make improvements in this area soon.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1024}{}\doxysubsection{Can I derive a test fixture from another?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1024}
Yes.
...
For a complete example using derived test fixtures, see \href{../samples/sample5_unittest.cc}{\texttt{ sample5}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1025}{}\doxysubsection{My compiler complains \char`\"{}void value not ignored as it ought to be.\char`\"{} What does this mean?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1025}
You\textquotesingle{}re probably using an {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$()} in a function that doesn\textquotesingle{}t return {\ttfamily void}. {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$()} can only be used in {\ttfamily void} functions.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1026}{}\doxysubsection{My death test hangs (or seg-\/faults). How do I fix it?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1026}
...
In the end, this boils down to good concurrent programming. You have to make sure that there is no race conditions or dead locks in your program. No silver bullet -\/ sorry!\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1027}{}\doxysubsection{Should I use the constructor/destructor of the test fixture or the set-\/up/tear-\/down function?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1027}
...
\end{DoxyItemize}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1028}{}\doxysubsection{The compiler complains \char`\"{}no matching function to call\char`\"{} when I use A\+S\+S\+E\+R\+T\+\_\+\+P\+R\+E\+Dn. How do I fix it?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1028}
...
\DoxyCodeLine{ASSERT\_PRED2(*(GreaterThan<int, int>)*, 5, 0);}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1029}{}\doxysubsection{My compiler complains about \char`\"{}ignoring return value\char`\"{} when I call R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S(). Why?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1029}
...
To help the users avoid this dangerous bug, the implementation of {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()}}} causes gcc to raise this warning, when the return value is ignored. If you see this warning, the fix is simple\+: just make sure its value is used as the return value of {\ttfamily \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1030}{}\doxysubsection{My compiler complains that a constructor (or destructor) cannot return a value. What\textquotesingle{}s going on?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1030}
...
we had to give up using {\ttfamily A\+S\+S\+E\+R\+T$\ast$} and {\ttfamily F\+A\+I\+L$\ast$} (but not {\ttfamily E\+X\+P\+E\+C\+T$\ast$} and {\ttfamily A\+D\+D\+\_\+\+F\+A\+I\+L\+U\+R\+E$\ast$}) in constructors and destructors. The workaround is to move the content of your constructor/destructor to a private void member function, or switch to {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()} if that works. This section in the user\textquotesingle{}s guide explains it.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1031}{}\doxysubsection{My set-\/up function is not called. Why?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1031}
C++ is case-\/sensitive. It should be spelled as {\ttfamily Set\+Up()}. Did you spell it as {\ttfamily Setup()}?

Similarly, sometimes people spell {\ttfamily Set\+Up\+Test\+Case()} as {\ttfamily Setup\+Test\+Case()} and wonder why it\textquotesingle{}s never called.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1032}{}\doxysubsection{How do I jump to the line of a failure in Emacs directly?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1032}
Google Test\textquotesingle{}s failure message format is understood by Emacs and many other I\+D\+Es, like acme and X\+Code. If a Google Test message is in a compilation buffer in Emacs, then it\textquotesingle{}s clickable. You can now hit {\ttfamily enter} on a message to jump to the corresponding source code, or use {\ttfamily C-\/x}\`{} to jump to the next failure.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1033}{}\doxysubsection{I have several test cases which share the same test fixture logic, do I have to define a new test fixture class for each of them? This seems pretty tedious.}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1033}
...
\DoxyCodeLine{TEST\_F(BarTest, Def) \{ ... \}}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1034}{}\doxysubsection{The Google Test output is buried in a whole bunch of log messages. What do I do?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1034}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1035}{}\doxysubsection{Why should I prefer test fixtures over global variables?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1035}
...
\end{DoxyEnumerate}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1036}{}\doxysubsection{How do I test private class members without writing F\+R\+I\+E\+N\+D\+\_\+\+T\+E\+S\+T()s?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1036}
...
\end{DoxyItemize}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1037}{}\doxysubsection{How do I test private class static members without writing F\+R\+I\+E\+N\+D\+\_\+\+T\+E\+S\+T()s?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1037}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1038}{}\doxysubsection{I would like to run a test several times with different parameters. Do I need to write several similar copies of it?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1038}
No. You can use a feature called \href{V1_6_AdvancedGuide.md\#Value_Parameterized_Tests}{\texttt{ value-\/parameterized tests}} which lets you repeat your tests with different parameters, without defining it more than once.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1039}{}\doxysubsection{How do I test a file that defines main()?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1039}
...
However, please remember this is a hack and should only be used as the last resort.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1040}{}\doxysubsection{What can the statement argument in A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H() be?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1040}
...
{\ttfamily googletest\+\_\+unittest.\+cc} contains more examples if you are interested.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1041}{}\doxysubsection{What syntax does the regular expression in A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H use?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1041}
On P\+O\+S\+IX systems, Google Test uses the P\+O\+S\+IX Extended regular expression syntax (\href{http://en.wikipedia.org/wiki/Regular_expression\#POSIX_Extended_Regular_Expressions}{\texttt{ http\+://en.\+wikipedia.\+org/wiki/\+Regular\+\_\+expression\#\+P\+O\+S\+I\+X\+\_\+\+Extended\+\_\+\+Regular\+\_\+\+Expressions}}). On Windows, it uses a limited variant of regular expression syntax. For more details, see the \href{V1_6_AdvancedGuide.md\#Regular_Expression_Syntax}{\texttt{ regular expression syntax}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1042}{}\doxysubsection{I have a fixture class Foo, but T\+E\+S\+T\+\_\+\+F(\+Foo, Bar) gives me error \char`\"{}no matching function for call to Foo\+::\+Foo()\char`\"{}. Why?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1042}
...
\end{DoxyItemize}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1043}{}\doxysubsection{Why does A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H complain about previous threads that were already joined?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1043}
...
The new N\+P\+TL thread library doesn\textquotesingle{}t suffer from this problem, as it doesn\textquotesingle{}t create a manager thread. However, if you don\textquotesingle{}t control which machine your test runs on, you shouldn\textquotesingle{}t depend on this.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1044}{}\doxysubsection{Why does Google Test require the entire test case, instead of individual tests, to be named F\+O\+O\+Death\+Test when it uses A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1044}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1046}{}\doxysubsection{The compiler complains about \char`\"{}no match for \textquotesingle{}operator$<$$<$\textquotesingle{}\char`\"{} when I use an assertion. What gives?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1046}
...
In addition, if {\ttfamily Foo\+Type} is declared in a name space, the {\ttfamily $<$$<$} operator also needs to be defined in the {\itshape same} name space.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1047}{}\doxysubsection{How do I suppress the memory leak messages on Windows?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1047}
Since the statically initialized Google Test singleton requires allocations on the heap, the Visual C++ memory leak detector will report memory leaks at the end of the program run. The easiest way to avoid this is to use the {\ttfamily \+\_\+\+Crt\+Mem\+Checkpoint} and {\ttfamily \+\_\+\+Crt\+Mem\+Dump\+All\+Objects\+Since} calls to not report any statically initialized heap objects. See M\+S\+DN for more details and additional heap check/debug routines.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1048}{}\doxysubsection{I am building my project with Google Test in Visual Studio and all I\textquotesingle{}m getting is a bunch of linker errors (or warnings). Help!}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1048}
...
To update this setting open the project properties in the Visual Studio I\+DE then select the branch Configuration Properties $\vert$ C/\+C++ $\vert$ Code Generation and change the option \char`\"{}\+Runtime Library\char`\"{}. You may also try using gtest-\/md.\+vcproj instead of gtest.\+vcproj.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1049}{}\doxysubsection{I put my tests in a library and Google Test doesn\textquotesingle{}t run them. What\textquotesingle{}s happening?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1049}
Have you read a \href{V1_6_Primer.md\#important-note-for-visual-c-users}{\texttt{ warning}} on the Google Test Primer page?\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1050}{}\doxysubsection{I want to use Google Test with Visual Studio but don\textquotesingle{}t know where to start.}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1050}
Many people are in your position and one of the posted his solution to our mailing list. Here is his link\+: \href{http://hassanjamilahmad.blogspot.com/2009/07/gtest-starters-help.html}{\texttt{ http\+://hassanjamilahmad.\+blogspot.\+com/2009/07/gtest-\/starters-\/help.\+html}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1051}{}\doxysubsection{I am seeing compile errors mentioning std\+::type\+\_\+traits when I try to use Google Test on Solaris.}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1051}
...
`export CC=cc C\+XX=CC C\+X\+X\+F\+L\+A\+GS='-\/library=stlport4\textquotesingle{}\`{}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1052}{}\doxysubsection{How can my code detect if it is running in a test?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1052}
...
However, if you {\itshape really}, {\itshape really}, {\itshape really} have no choice, and if you follow the rule of ending your test program names with {\ttfamily \+\_\+test}, you can use the {\itshape horrible} hack of sniffing your executable name ({\ttfamily argv\mbox{[}0\mbox{]}} in {\ttfamily \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}}) to know whether the code is under test.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1053}{}\doxysubsection{Google Test defines a macro that clashes with one defined by another library. How do I deal with that?}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1053}
...
Currently, the following {\ttfamily T\+E\+ST}, {\ttfamily F\+A\+IL}, {\ttfamily S\+U\+C\+C\+E\+ED}, and the basic comparison assertion macros can have alternative names. You can see the full list of covered macros \href{http://www.google.com/codesearch?q=if+!GTEST_DONT_DEFINE_\\w\%2B+package:http://googletest\\.googlecode\\.com+file:/include/gtest/gtest.h}{\texttt{ here}}. More information can be found in the \char`\"{}\+Avoiding Macro Name Clashes\char`\"{} section of the R\+E\+A\+D\+ME file.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1054}{}\doxysubsection{My question is not covered in your F\+A\+Q!}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1054}

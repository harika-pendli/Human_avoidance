\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md12}{}\doxysection{Mocking a Normal Class}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md12}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md13}{}\doxysection{Mocking a Class Template}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md13}
To mock 
\begin{DoxyCode}{0}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md14}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md14}
...
where {\ttfamily S\+T\+D\+M\+E\+T\+H\+O\+D\+C\+A\+L\+L\+T\+Y\+PE} is defined by {\ttfamily $<$objbase.\+h$>$} on Windows.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md15}{}\doxysection{Using Mocks in Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md15}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\DoxyCodeLine{\}                                                 // \#6}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md16}{}\doxysection{Setting Default Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md16}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md17}{}\doxysection{Setting Expectations}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md17}
...
A method with no {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md18}{}\doxysection{Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md18}
...
Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md19}{}\doxysubsection{Wildcard}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md19}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md20}{}\doxysubsection{Generic Comparison}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md20}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md22}{}\doxysubsection{String Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md22}
...
{\ttfamily \mbox{\hyperlink{namespacetesting_a899838630a71376aa071dfd7c500f2ca}{Contains\+Regex()}}} and {\ttfamily \mbox{\hyperlink{namespacetesting_a4dac232f315edc259b62ce88e413b107}{Matches\+Regex()}}} use the regular expression syntax defined \href{../../googletest/docs/AdvancedGuide.md\#regular-expression-syntax}{\texttt{ here}}. {\ttfamily \mbox{\hyperlink{namespacetesting_addbdb8c0902ab09cade24fa6db7c0073}{Str\+Case\+Eq()}}}, {\ttfamily \mbox{\hyperlink{namespacetesting_a9596fd67bdd5df195bc54382f91a1906}{Str\+Case\+Ne()}}}, {\ttfamily \mbox{\hyperlink{namespacetesting_a154de81376ae7d584c6e5a619b45fb09}{Str\+Eq()}}}, and {\ttfamily \mbox{\hyperlink{namespacetesting_a6f6b8af3d19cb969df0eb995c47a14d2}{Str\+Ne()}}} work for wide strings as well.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md23}{}\doxysubsection{Container Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md23}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md24}{}\doxysubsection{Member Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md24}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md25}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md25}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md26}{}\doxysubsection{Pointer Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md26}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md27}{}\doxysubsection{Multiargument Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md27}
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md28}{}\doxysubsection{Composite Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md28}
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md29}{}\doxysubsection{Adapters for Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md29}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md30}{}\doxysubsection{Matchers as Predicates}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md30}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md31}{}\doxysubsection{Defining Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md31}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyEnumerate}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md32}{}\doxysubsection{Matchers as Test Assertions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md32}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md33}{}\doxysection{Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md33}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md34}{}\doxysubsection{Returning a Value}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md34}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md35}{}\doxysubsection{Side Effects}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md35}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md36}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md36}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md37}{}\doxysubsection{Default Action}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md37}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily \mbox{\hyperlink{namespacetesting_ae041df61ff61ccb9753ba15b4309e1a6}{Do\+Default()}}} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md38}{}\doxysubsection{Composite Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md38}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md39}{}\doxysubsection{Defining Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md39}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The {\ttfamily A\+C\+T\+I\+O\+N$\ast$} macros cannot be used inside a function or class.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md40}{}\doxysection{Cardinalities}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md40}
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md41}{}\doxysection{Expectation Order}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md41}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md42}{}\doxysubsection{The After Clause}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md42}
...
Modifying an {\ttfamily Expectation\+Set} after using it in an {\ttfamily .After()} doesn\textquotesingle{}t affect the meaning of the {\ttfamily .After()}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md43}{}\doxysubsection{Sequences}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md43}
...
says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md44}{}\doxysection{Verifying and Resetting a Mock}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md44}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md45}{}\doxysection{Mock Classes}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md45}
...
See this \href{CookBook.md\#using-check-points}{\texttt{ recipe}} for one application of it.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md46}{}\doxysection{Flags}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md46}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline

You can find recipes for using Google \mbox{\hyperlink{class_mock}{Mock}} here. If you haven\textquotesingle{}t yet, please read the \mbox{\hyperlink{v1__7_2_for_dummies_8md}{For\+Dummies}} document first to make sure you understand the basics.

{\bfseries{Note\+:}} Google \mbox{\hyperlink{class_mock}{Mock}} lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by Google \mbox{\hyperlink{class_mock}{Mock}}. We omit such {\ttfamily using} statements in this page for brevity, but you should do it in your own code.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md47}{}\doxysection{Creating Mock Classes}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md47}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md48}{}\doxysubsection{Mocking Private or Protected Methods}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md48}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md49}{}\doxysubsection{Mocking Overloaded Methods}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md49}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md50}{}\doxysubsection{Mocking Class Templates}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md50}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md51}{}\doxysubsection{Mocking Nonvirtual Methods}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md51}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md52}{}\doxysubsection{Mocking Free Functions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md52}
...
If you are concerned about the performance overhead incurred by virtual functions, and profiling confirms your concern, you can combine this with the recipe for \href{\#mocking-nonvirtual-methods}{\texttt{ mocking non-\/virtual methods}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md53}{}\doxysubsection{The Nice, the Strict, and the Naggy}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md53}
...
By defining a new mock method with a trimmed argument list, we make the mock class much more user-\/friendly.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md55}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md55}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md56}{}\doxysubsection{Delegating Calls to a Fake}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md56}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily I\+O\+Ops} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily I\+O\+Ops} without mocking {\ttfamily File\+Ops}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md57}{}\doxysubsection{Delegating Calls to a Real Object}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md57}
...
(Why don\textquotesingle{}t we just write {\ttfamily Invoke(\&foo, \&\+Foo\+::\+Concrete)}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md59}{}\doxysection{Using Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md59}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md60}{}\doxysubsection{Matching Argument Values Exactly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md60}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md61}{}\doxysubsection{Using Simple Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md61}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md62}{}\doxysubsection{Combining Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md62}
You can build complex matchers from existing ones using {\ttfamily \mbox{\hyperlink{namespacetesting_af7618e8606c1cb45738163688944e2b7}{All\+Of()}}}, {\ttfamily \mbox{\hyperlink{namespacetesting_a81cfefd9f75cdce827d5bc873cf73aac}{Any\+Of()}}}, and {\ttfamily \mbox{\hyperlink{namespacetesting_a3d7d0dda7e51b13fe2f5aa28e23ed6b6}{Not()}}}\+:
...
\DoxyCodeLine{                          NULL));}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md63}{}\doxysubsection{Casting Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md63}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md64}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md64}
If you expect an overloaded function to be called, the compiler may need some help on which overloaded version it is.

To disambiguate functions overloaded on the const-\/ness of this object, use the {\ttfamily \mbox{\hyperlink{namespacetesting_a945ac56c5508a3c9c032bbe8aae8dcfa}{Const()}}} argument wrapper.
...
({\ttfamily \mbox{\hyperlink{namespacetesting_a945ac56c5508a3c9c032bbe8aae8dcfa}{Const()}}} is defined by Google \mbox{\hyperlink{class_mock}{Mock}} and returns a {\ttfamily const} reference to its argument.)
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md65}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md65}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md66}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md66}
...
As a convenience and example, Google \mbox{\hyperlink{class_mock}{Mock}} provides some matchers for 2-\/tuples, including the {\ttfamily \mbox{\hyperlink{namespacetesting_ad621459957a8bcdd3c256b7940ecbf99}{Lt()}}} matcher above. See the \mbox{\hyperlink{v1__7_2_cheat_sheet_8md}{Cheat\+Sheet}} for the complete list.

Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args$<$0, 1$>$(Truly(\&\+My\+Predicate)))}), that predicate M\+U\+ST be written to take a {\ttfamily \+::testing\+::tuple} as its argument; Google \mbox{\hyperlink{class_mock}{Mock}} will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md67}{}\doxysubsection{Using Matchers as Predicates}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md67}
...
Luckily, you can use a matcher where a unary predicate functor is expected by wrapping it inside the {\ttfamily \mbox{\hyperlink{namespacetesting_ad53b509ae9cd51040d67f668f99702ae}{Matches()}}} function. For example,
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md68}{}\doxysubsection{Using Matchers in Google Test Assertions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md68}
...
{\bfseries{Credit\+:}} The idea of {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+T\+H\+AT} was stolen from the \href{https://github.com/hamcrest/}{\texttt{ Hamcrest}} project, which adds {\ttfamily assert\+That()} to J\+Unit.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md69}{}\doxysubsection{Using Predicates as Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md69}
Google \mbox{\hyperlink{class_mock}{Mock}} provides a built-\/in set of matchers. In case you find them lacking, you can use an arbitray unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily \mbox{\hyperlink{namespacetesting_a5faf05cfaae6074439960048e478b1c8}{Truly()}}} function, for example\+:
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in statement {\ttfamily if (condition) ...}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md70}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md70}
When you do an {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L(mock\+\_\+obj, Foo(bar))}}}, Google \mbox{\hyperlink{class_mock}{Mock}} saves away a copy of {\ttfamily bar}. When {\ttfamily Foo()} is called later, Google \mbox{\hyperlink{class_mock}{Mock}} compares the argument to {\ttfamily Foo()} with the saved copy of {\ttfamily bar}. This way, you don\textquotesingle{}t need to worry about {\ttfamily bar} being modified or destroyed after the {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} is executed. The same is true when you use matchers like {\ttfamily Eq(bar)}, {\ttfamily Le(bar)}, and so on.

But what if {\ttfamily bar} cannot be copied (i.\+e. has no copy constructor)? You could define your own matcher function and use it with {\ttfamily \mbox{\hyperlink{namespacetesting_a5faf05cfaae6074439960048e478b1c8}{Truly()}}}, as the previous couple of recipes have shown. Or, you may be able to get away from it if you can guarantee that {\ttfamily bar} won\textquotesingle{}t be changed after the {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} is executed. Just tell Google \mbox{\hyperlink{class_mock}{Mock}} that it should save a reference to {\ttfamily bar}, instead of a copy of it. Here\textquotesingle{}s how\+:
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}}, or the result is undefined.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md71}{}\doxysubsection{Validating a Member of an Object}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md71}
Often a mock function takes a reference to object as an argument. When matching the argument, you may not want to compare the entire object against a fixed object, as that may be over-\/specification. Instead, you may need to validate a certain member variable or the result of a certain getter method of the object. You can do this with {\ttfamily \mbox{\hyperlink{namespacetesting_a4df3849391696aa93ac3a7703a717c2a}{Field()}}} and {\ttfamily \mbox{\hyperlink{namespacetesting_a0fad10571e23f7bc0d5c83d4c31ba740}{Property()}}}. More specifically,
...
B\+TW, {\ttfamily \mbox{\hyperlink{namespacetesting_a4df3849391696aa93ac3a7703a717c2a}{Field()}}} and {\ttfamily \mbox{\hyperlink{namespacetesting_a0fad10571e23f7bc0d5c83d4c31ba740}{Property()}}} can also match plain pointers to objects. For instance,
...
What if you want to validate more than one members at the same time? Remember that there is {\ttfamily \mbox{\hyperlink{namespacetesting_af7618e8606c1cb45738163688944e2b7}{All\+Of()}}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md72}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md72}
C++ functions often take pointers as arguments. You can use matchers like {\ttfamily \mbox{\hyperlink{namespacetesting_a56ffb1a169c14ce585fc5bed32add2db}{Is\+Null()}}}, {\ttfamily \mbox{\hyperlink{namespacetesting_a39d1f92b53b8b2a0b6db6a22ac146416}{Not\+Null()}}}, and other comparison matchers to match a pointer, but what if you want to make sure the value {\itshape pointed to} by the pointer, instead of the pointer itself, has a certain property? Well, you can use the {\ttfamily Pointee(m)} matcher.
...
One nice thing about {\ttfamily \mbox{\hyperlink{namespacetesting_a5122ca3533f3a00f67e146dd81f3b68c}{Pointee()}}} is that it treats a {\ttfamily N\+U\+LL} pointer as a match failure, so you can write {\ttfamily Pointee(m)} instead of
...
Also, did we tell you that {\ttfamily \mbox{\hyperlink{namespacetesting_a5122ca3533f3a00f67e146dd81f3b68c}{Pointee()}}} works with both raw pointers {\bfseries{and}} smart pointers ({\ttfamily linked\+\_\+ptr}, {\ttfamily shared\+\_\+ptr}, {\ttfamily scoped\+\_\+ptr}, and etc)?

What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily \mbox{\hyperlink{namespacetesting_a5122ca3533f3a00f67e146dd81f3b68c}{Pointee()}}} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md73}{}\doxysubsection{Testing a Certain Property of an Object}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md73}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md74}{}\doxysubsection{Matching Containers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md74}
...
{\ttfamily \mbox{\hyperlink{namespacetesting_a79cf4ae694bf8231dcf283b325405f27}{Elements\+Are()}}} and {\ttfamily \mbox{\hyperlink{namespacetesting_a8622c12aadfa0e60f7d68683eeb21115}{Unordered\+Elements\+Are()}}} are overloaded to take 0 to 10 arguments. If more are needed, you can place them in a C-\/style array and use {\ttfamily \mbox{\hyperlink{namespacetesting_ae2eee06e7ddbf5f5372fd24372e9703f}{Elements\+Are\+Array()}}} or {\ttfamily \mbox{\hyperlink{namespacetesting_ab4896081406209171a1596b7028e1cf7}{Unordered\+Elements\+Are\+Array()}}} instead\+:
...
In case the array needs to be dynamically created (and therefore the array size cannot be inferred by the compiler), you can give {\ttfamily \mbox{\hyperlink{namespacetesting_ae2eee06e7ddbf5f5372fd24372e9703f}{Elements\+Are\+Array()}}} an additional argument to specify the array size\+:
...
\end{DoxyItemize}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md75}{}\doxysubsection{Sharing Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md75}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md76}{}\doxysection{Setting Expectations}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md76}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md77}{}\doxysubsection{Knowing When to Expect}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md77}
...
If you are bothered by the \char`\"{}\+Uninteresting mock function call\char`\"{} message printed when a mock method without an {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL} is called, you may use a {\ttfamily Nice\+Mock} instead to suppress all such messages for the mock object, or suppress the message for specific methods by adding {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L(...)}}.Times(\+Any\+Number())}. DO N\+OT suppress it by blindly adding an {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L(...)}}}, or you\textquotesingle{}ll have a test that\textquotesingle{}s a pain to maintain.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md78}{}\doxysubsection{Ignoring Uninteresting Calls}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md78}
If you are not interested in how a mock method is called, just don\textquotesingle{}t say anything about it. In this case, if the method is ever called, Google \mbox{\hyperlink{class_mock}{Mock}} will perform its default action to allow the test program to continue. If you are not happy with the default action taken by Google \mbox{\hyperlink{class_mock}{Mock}}, you can override it using {\ttfamily Default\+Value$<$T$>$\+::\+Set()} (described later in this document) or {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a5b12ae6cf84f0a544ca811b380c37334}{O\+N\+\_\+\+C\+A\+L\+L()}}}.

Please note that once you expressed interest in a particular mock method (via {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} statement, it will be an error.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md79}{}\doxysubsection{Disallowing Unexpected Calls}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md79}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} statements will be an error.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md80}{}\doxysubsection{Understanding Uninteresting vs Unexpected Calls}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md80}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \href{\#the-nice-the-strict-and-the-naggy}{\texttt{ \char`\"{}\+The Nice, the Strict, and the Naggy\char`\"{}}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md81}{}\doxysubsection{Expecting Ordered Calls}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md81}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, Google \mbox{\hyperlink{class_mock}{Mock}} will report an error.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md82}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md82}
...
If we view {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} statements as nodes in a graph, and add an edge from node A to node B wherever A must occur before B, we can get a D\+AG. We use the term \char`\"{}sequence\char`\"{} to mean a directed path in this D\+AG. Now, if we decompose the D\+AG into sequences, we just need to know which sequences each {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}} belongs to in order to be able to reconstruct the orginal D\+AG.
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md83}{}\doxysubsection{Controlling When an Expectation Retires}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md83}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md84}{}\doxysection{Using Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md84}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md85}{}\doxysubsection{Returning References from Mock Methods}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md85}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md86}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md86}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md87}{}\doxysubsection{Combining Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md87}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md88}{}\doxysubsection{Mocking Side Effects}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md88}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{using ::testing::\_;}
\DoxyCodeLine{using ::testing::SeArrayArgument;}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md89}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md89}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md90}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md90}
...
Please note that changing the default value for a type can make you tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md91}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md91}
...
The only requirement is that the type of the function, etc must be {\itshape compatible} with the signature of the mock function, meaning that the latter\textquotesingle{}s arguments can be implicitly converted to the corresponding arguments of the former, and the former\textquotesingle{}s return type can be implicitly converted to that of the latter. So, you can invoke something whose type is {\itshape not} exactly the same as the mock function, as long as it\textquotesingle{}s safe to do so -\/ nice, huh?\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md93}{}\doxysubsection{Invoking a Function/\+Method/\+Functor Without Arguments}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md93}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md94}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md94}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md95}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md95}
...
Note that you {\bfseries{cannot}} use {\ttfamily \mbox{\hyperlink{namespacetesting_a50ae42540a31047c7fddd32df8d835f5}{Ignore\+Result()}}} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md96}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md96}
...
\end{DoxyItemize}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md97}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md97}
...
\DoxyCodeLine{      .WillOnce(Invoke(DistanceToOrigin));}
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md98}{}\doxysubsection{Sharing Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md98}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md99}{}\doxysection{Misc Recipes on Using Google Mock}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md99}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md100}{}\doxysubsection{Mocking Methods That Use Move-\/\+Only Types}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md100}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{enum class AccessLevel \{ kInternal, kPublic \};}
\DoxyCodeLine{}
\DoxyCodeLine{class Buzz \{}
\DoxyCodeLine{ public:}
\DoxyCodeLine{  explicit Buzz(AccessLevel access) \{ … \}}
\DoxyCodeLine{  ...}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{class Buzzer \{}
\DoxyCodeLine{ public:}
\DoxyCodeLine{  virtual \string~Buzzer() \{\}}
\DoxyCodeLine{  virtual std::unique\_ptr<Buzz> MakeBuzz(const std::string\& text) = 0;}
\DoxyCodeLine{  virtual bool ShareBuzz(std::unique\_ptr<Buzz> buzz, Time timestamp) = 0;}
\DoxyCodeLine{  ...}
\DoxyCodeLine{\};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{class MockBuzzer : public Buzzer \{}
\DoxyCodeLine{ public:}
\DoxyCodeLine{  MOCK\_METHOD1(MakeBuzz, std::unique\_ptr<Buzz>(const std::string\& text));}
\DoxyCodeLine{  …}
\DoxyCodeLine{\};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{// Does NOT compile!}
\DoxyCodeLine{MOCK\_METHOD2(ShareBuzz, bool(std::unique\_ptr<Buzz> buzz, Time timestamp));}
\end{DoxyCode}
...
\DoxyCodeLine{ public:}
\DoxyCodeLine{  MOCK\_METHOD1(MakeBuzz, std::unique\_ptr<Buzz>(const std::string\& text));}
\DoxyCodeLine{  MOCK\_METHOD2(DoShareBuzz, bool(Buzz* buzz, Time timestamp));}
\DoxyCodeLine{  bool ShareBuzz(std::unique\_ptr<Buzz> buzz, Time timestamp) \{}
\DoxyCodeLine{    return DoShareBuzz(buzz.get(), timestamp);}
\DoxyCodeLine{  \}}
\DoxyCodeLine{\};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{// Use the default action.}
\DoxyCodeLine{EXPECT\_CALL(mock\_buzzer\_, MakeBuzz("hello"));}
\DoxyCodeLine{}
\DoxyCodeLine{// Triggers the previous EXPECT\_CALL.}
\DoxyCodeLine{EXPECT\_EQ(nullptr, mock\_buzzer\_.MakeBuzz("hello"));}
\end{DoxyCode}


If you are not happy with the default action, you can tweak it. Depending on what you need, you may either tweak the default action for a specific (mock object, mock method) combination using {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a5b12ae6cf84f0a544ca811b380c37334}{O\+N\+\_\+\+C\+A\+L\+L()}}}, or you may tweak the default action for all mock methods that return a specific type. The usage of {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a5b12ae6cf84f0a544ca811b380c37334}{O\+N\+\_\+\+C\+A\+L\+L()}}} is similar to {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}}}, so we’ll skip it and just explain how to do the latter (tweaking the default action for a specific return type). You do this via the {\ttfamily Default\+Value$<$$>$\+::\+Set\+Factory()} and {\ttfamily Default\+Value$<$$>$\+::\+Clear()} A\+PI\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{// Sets the default action for return type std::unique\_ptr<Buzz> to}
\DoxyCodeLine{// creating a new Buzz every time.}
\DoxyCodeLine{DefaultValue<std::unique\_ptr<Buzz>>::SetFactory(}
\DoxyCodeLine{    [] \{ return MakeUnique<Buzz>(AccessLevel::kInternal); \});}
\DoxyCodeLine{}
\DoxyCodeLine{// When this fires, the default action of MakeBuzz() will run, which}
\DoxyCodeLine{// will return a new Buzz object.}
\DoxyCodeLine{EXPECT\_CALL(mock\_buzzer\_, MakeBuzz("hello")).Times(AnyNumber());}
\DoxyCodeLine{}
\DoxyCodeLine{auto buzz1 = mock\_buzzer\_.MakeBuzz("hello");}
\DoxyCodeLine{auto buzz2 = mock\_buzzer\_.MakeBuzz("hello");}
\DoxyCodeLine{EXPECT\_NE(nullptr, buzz1);}
\DoxyCodeLine{EXPECT\_NE(nullptr, buzz2);}
\DoxyCodeLine{EXPECT\_NE(buzz1, buzz2);}
\DoxyCodeLine{}
\DoxyCodeLine{// Resets the default action for return type std::unique\_ptr<Buzz>,}
\DoxyCodeLine{// to avoid interfere with other tests.}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{// When this fires, the unique\_ptr<> specified by ByMove(...) will}
\DoxyCodeLine{// be returned.}
\DoxyCodeLine{EXPECT\_CALL(mock\_buzzer\_, MakeBuzz("world"))}
\DoxyCodeLine{    .WillOnce(Return(ByMove(MakeUnique<Buzz>(AccessLevel::kInternal))));}
\DoxyCodeLine{}
\DoxyCodeLine{EXPECT\_NE(nullptr, mock\_buzzer\_.MakeBuzz("world"));}
\end{DoxyCode}
...
If you need your mock method to do more than just moving a pre-\/defined value, remember that you can always use {\ttfamily \mbox{\hyperlink{namespacetesting_a12aebaf8363d49a383047529f798b694}{Invoke()}}} to call a lambda or a callable object, which can do pretty much anything you want\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{EXPECT\_CALL(mock\_buzzer\_, MakeBuzz("x"))}
\DoxyCodeLine{    .WillRepeatedly(Invoke([](const std::string\& text) \{}
\DoxyCodeLine{      return std::make\_unique<Buzz>(AccessLevel::kInternal);}
\DoxyCodeLine{    \}));}
\DoxyCodeLine{}
\DoxyCodeLine{EXPECT\_NE(nullptr, mock\_buzzer\_.MakeBuzz("x"));}
\DoxyCodeLine{EXPECT\_NE(nullptr, mock\_buzzer\_.MakeBuzz("x"));}
\end{DoxyCode}
...
\DoxyCodeLine{}
\DoxyCodeLine{// When one calls ShareBuzz() on the MockBuzzer like this, the call is}
\DoxyCodeLine{// forwarded to DoShareBuzz(), which is mocked.  Therefore this statement}
\DoxyCodeLine{// will trigger the above EXPECT\_CALL.}
\DoxyCodeLine{mock\_buzzer\_.ShareBuzz(MakeUnique\&lt;Buzz\&gt;(AccessLevel::kInternal),}
\DoxyCodeLine{                       ::base::Now());}
\end{DoxyCode}
...
\DoxyCodeLine{class MockBuzzer : public Buzzer \{}
\DoxyCodeLine{ public:}
\DoxyCodeLine{  MockBuzzer() \{}
\DoxyCodeLine{    // Since DoShareBuzz(buzz, time) is supposed to take ownership of}
\DoxyCodeLine{    // buzz, define a default behavior for DoShareBuzz(buzz, time) to}
\DoxyCodeLine{    // delete buzz.}
\DoxyCodeLine{    ON\_CALL(*this, DoShareBuzz(\_, \_))}
\DoxyCodeLine{        .WillByDefault(Invoke([](Buzz* buzz, Time timestamp) \{}
\DoxyCodeLine{          delete buzz;}
\DoxyCodeLine{          return true;}
\DoxyCodeLine{        \}));}
\DoxyCodeLine{  \}}
...
\DoxyCodeLine{  MOCK\_METHOD1(MakeBuzz, std::unique\_ptr<Buzz>(const std::string\& text));}
\DoxyCodeLine{}
\DoxyCodeLine{  // Takes ownership of buzz.}
\DoxyCodeLine{  MOCK\_METHOD2(DoShareBuzz, bool(Buzz* buzz, Time timestamp));}
\DoxyCodeLine{  bool ShareBuzz(std::unique\_ptr<Buzz> buzz, Time timestamp) \{}
\DoxyCodeLine{    return DoShareBuzz(buzz.release(), timestamp);}
\DoxyCodeLine{  \}}
\DoxyCodeLine{\};}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{std::unique\_ptr<Buzz> intercepted\_buzz;}
\DoxyCodeLine{EXPECT\_CALL(mock\_buzzer\_, DoShareBuzz(NotNull(), \_))}
\DoxyCodeLine{    .WillOnce(Invoke([\&amp;intercepted\_buzz](Buzz* buzz, Time timestamp) \{}
\DoxyCodeLine{      // Save buzz in intercepted\_buzz for analysis later.}
\DoxyCodeLine{      intercepted\_buzz.reset(buzz);}
\DoxyCodeLine{      return false;}
\DoxyCodeLine{    \}));}
\DoxyCodeLine{}
\DoxyCodeLine{mock\_buzzer\_.ShareBuzz(std::make\_unique<Buzz>(AccessLevel::kInternal),}
\DoxyCodeLine{                       Now());}
\DoxyCodeLine{EXPECT\_NE(nullptr, intercepted\_buzz);}
\end{DoxyCode}


Using the tricks covered in this recipe, you are now able to mock methods that take and/or return move-\/only types. Put your newly-\/acquired power to good use -\/ when you design a new A\+PI, you can now feel comfortable using {\ttfamily unique\+\_\+ptrs} as appropriate, without fearing that doing so will compromise your tests.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md101}{}\doxysubsection{Making the Compilation Faster}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md101}
...
\DoxyCodeLine{  MockFoo();}
\DoxyCodeLine{  virtual \string~MockFoo();}
\DoxyCodeLine{}
\DoxyCodeLine{  MOCK\_METHOD0(DoThis, int());}
\DoxyCodeLine{  MOCK\_METHOD1(DoThat, bool(const char* str));}
\DoxyCodeLine{  ... more mock methods ...}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md102}{}\doxysubsection{Forcing a Verification}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md102}
When it\textquotesingle{}s being destoyed, your friendly mock object will automatically verify that all expectations on it have been satisfied, and will generate \href{../../googletest/}{\texttt{ Google Test}} failures if not. This is convenient as it leaves you with one less thing to worry about. That is, unless you are not sure if your mock object will be destoyed.
...
{\bfseries{Tip\+:}} The {\ttfamily Mock\+::\+Verify\+And\+Clear\+Expectations()} function returns a {\ttfamily bool} to indicate whether the verification was successful ({\ttfamily true} for yes), so you can wrap that function call inside a {\ttfamily \mbox{\hyperlink{gtest_8h_ae9244bfbda562e8b798789b001993fa5}{A\+S\+S\+E\+R\+T\+\_\+\+T\+R\+U\+E()}}} if there is no point going further when the verification has failed.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md103}{}\doxysubsection{Using Check Points}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md103}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{MOCK\_METHOD0(\string~MockFoo, void());  // Won't compile!}
\end{DoxyCode}
...
\DoxyCodeLine{  virtual \string~MockFoo() \{ Die(); \}}
\DoxyCodeLine{\};}
\end{DoxyCode}
...
And that\textquotesingle{}s that.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md105}{}\doxysubsection{Using Google Mock and Threads}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md105}
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md106}{}\doxysubsection{Controlling How Much Information Google Mock Prints}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md106}
...
Now, judiciously use the right flag to enable Google \mbox{\hyperlink{class_mock}{Mock}} serve you better!\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md107}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md107}
...
Then you can type {\ttfamily M-\/m} to start a build, or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md109}{}\doxysubsection{Fusing Google Mock Source Files}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md109}
...
and you should see an {\ttfamily O\+U\+T\+P\+U\+T\+\_\+\+D\+IR} directory being created with files {\ttfamily \mbox{\hyperlink{gtest_8h}{gtest/gtest.\+h}}}, {\ttfamily \mbox{\hyperlink{gmock_8h}{gmock/gmock.\+h}}}, and {\ttfamily gmock-\/gtest-\/all.\+cc} in it. These three files contain everything you need to use Google \mbox{\hyperlink{class_mock}{Mock}} (and Google Test). Just copy them to anywhere you want and you are ready to write tests and use mocks. You can use the \href{../scripts/test/Makefile}{\texttt{ scrpts/test/\+Makefile}} file as an example on how to compile your tests against them.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md110}{}\doxysection{Extending Google Mock}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md110}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md111}{}\doxysubsection{Writing New Matchers Quickly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md111}
...
You should let {\ttfamily Match\+And\+Explain()} print {\itshape any additional information} that can help a user understand the match result. Note that it should explain why the match succeeds in case of a success (unless it\textquotesingle{}s obvious) -\/ this is useful when the matcher is used inside {\ttfamily \mbox{\hyperlink{namespacetesting_a3d7d0dda7e51b13fe2f5aa28e23ed6b6}{Not()}}}. There is no need to print the argument value itself, as Google \mbox{\hyperlink{class_mock}{Mock}} already prints it for you.
...
\end{DoxyEnumerate}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md112}{}\doxysubsection{Writing New Parameterized Matchers Quickly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md112}
...
While it\textquotesingle{}s tempting to always use the {\ttfamily M\+A\+T\+C\+H\+E\+R$\ast$} macros when defining a new matcher, you should also consider implementing {\ttfamily Matcher\+Interface} or using {\ttfamily \mbox{\hyperlink{namespacetesting_a667ca94f190ec2e17ee2fbfdb7d3da04}{Make\+Polymorphic\+Matcher()}}} instead (see the recipes that follow), especially if you need to use the matcher a lot. While these approaches require more work, they give you more control on the types of the value being matched and the matcher parameters, which in general leads to better compiler error messages that pay off in the long run. They also allow overloading matchers based on parameter types (as opposed to just based on the number of parameters).\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md113}{}\doxysubsection{Writing New Monomorphic Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md113}
...
\DoxyCodeLine{ public:}
\DoxyCodeLine{  virtual \string~MatcherInterface();}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md114}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md114}
You\textquotesingle{}ve learned how to write your own matchers in the previous recipe. Just one problem\+: a matcher created using {\ttfamily \mbox{\hyperlink{namespacetesting_a37fd8029ac00e60952440a3d9cca8166}{Make\+Matcher()}}} only works for one particular type of arguments. If you want a {\itshape polymorphic} matcher that works with arguments of several types (for instance, {\ttfamily Eq(x)} can be used to match a {\ttfamily value} as long as {\ttfamily value} == {\ttfamily x} compiles -- {\ttfamily value} and {\ttfamily x} don\textquotesingle{}t have to share the same type), you can learn the trick from {\ttfamily \char`\"{}gmock/gmock-\/matchers.\+h\char`\"{}} but it\textquotesingle{}s a bit involved.

Fortunately, most of the time you can define a polymorphic matcher easily with the help of {\ttfamily \mbox{\hyperlink{namespacetesting_a667ca94f190ec2e17ee2fbfdb7d3da04}{Make\+Polymorphic\+Matcher()}}}. Here\textquotesingle{}s how you can define {\ttfamily \mbox{\hyperlink{namespacetesting_a39d1f92b53b8b2a0b6db6a22ac146416}{Not\+Null()}}} as an example\+:
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md115}{}\doxysubsection{Writing New Cardinalities}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md115}
...
\DoxyCodeLine{ public:}
\DoxyCodeLine{  virtual \string~CardinalityInterface();}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md116}{}\doxysubsection{Writing New Actions Quickly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md116}
...
\end{longtabu}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md117}{}\doxysubsection{Writing New Parameterized Actions Quickly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md117}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md118}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an A\+C\+T\+I\+ON}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md118}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in Google Test that verifies two types are the same.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md119}{}\doxysubsection{Writing New Action Templates Quickly}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md119}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md120}{}\doxysubsection{Using the A\+C\+T\+I\+O\+N Object\textquotesingle{}s Type}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md120}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md121}{}\doxysubsection{Writing New Monomorphic Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md121}
...
\DoxyCodeLine{ public:}
\DoxyCodeLine{  virtual \string~ActionInterface();}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md122}{}\doxysubsection{Writing New Polymorphic Actions}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md122}
...
\end{DoxyCode}
\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md123}{}\doxysubsection{Teaching Google Mock How to Print Your Values}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googlemock_docs__cook_book_autotoc_md123}

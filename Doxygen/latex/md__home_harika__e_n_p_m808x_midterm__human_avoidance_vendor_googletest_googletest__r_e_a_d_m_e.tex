\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1234}{}\doxysubsubsection{Setup}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1234}
To build Google Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1235}{}\doxysubsubsection{Build}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1235}
...
If you see errors, try to tweak the contents of {\ttfamily make/\+Makefile} to make them go away. There are instructions in {\ttfamily make/\+Makefile} on how to do it.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1236}{}\doxysubsection{Using C\+Make}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1236}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1237}{}\doxysubsection{Legacy Build Scripts}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1237}
...
\end{DoxyItemize}\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1238}{}\doxysubsection{Tweaking Google Test}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1238}
...
We list the most frequently used macros below. For a complete list, see file \href{include/gtest/internal/gtest-port.h}{\texttt{ include/gtest/internal/gtest-\/port.\+h}}.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1239}{}\doxysubsection{Choosing a T\+R1 Tuple Library}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1239}
...
and all features using tuple will be disabled.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1240}{}\doxysubsection{Multi-\/threaded Tests}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1240}
...
Note\+: while the above steps aren\textquotesingle{}t technically necessary today when using some compilers (e.\+g. G\+CC), they may become necessary in the future, if we decide to improve the speed of loading the library (see \href{http://gcc.gnu.org/wiki/Visibility}{\texttt{ http\+://gcc.\+gnu.\+org/wiki/\+Visibility}} for details). Therefore you are recommended to always add the above flags when using Google Test as a shared library. Otherwise a future release of Google Test may break your build script.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1242}{}\doxysubsection{Avoiding Macro Name Clashes}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1242}
...
in order to define a test.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1243}{}\doxysection{Developing Google Test}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1243}
This section discusses how to make your own changes to Google Test.\hypertarget{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1244}{}\doxysubsection{Testing Google Test Itself}\label{md__home_harika__e_n_p_m808x_midterm__human_avoidance_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1244}
...
Normally you don\textquotesingle{}t need to worry about regenerating the source files, unless you need to modify them. In that case, you should modify the corresponding .pump files instead and run the \mbox{\hyperlink{pump_8py}{pump.\+py}} Python script to regenerate them. You can find \mbox{\hyperlink{pump_8py}{pump.\+py}} in the \href{scripts/}{\texttt{ scripts/}} directory. Read the \mbox{\hyperlink{_pump_manual_8md}{Pump manual}} for how to use it. 
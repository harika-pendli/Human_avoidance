...
class Camera
{
    ...
    public:
    void set_intrinsic_camera_params (float,float,float,float,float);  // supposed to be the intrinsic matrix of the camera
    void set_rotation_camera_params (float,float,float,float,float,float,float,float,float);  // supposed to be rotation part of the extrinsic params matrix
    void set_translation_camera_params (float,float,float);  //translation part of the extrinsic params matrix
